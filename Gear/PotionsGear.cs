namespace CombSim.Gear
{
    public static class PotionsGear
    {
        ...
        public static readonly Potion GreaterHealingPotion = new GenericHealingPotion("Greater Healing Potion", "4d4+4");
        public static readonly Potion SuperiorHealingPotion = new GenericHealingPotion("Superior Healing Potion", "8d4+8");
        public static readonly Potion SupremeHealingPotion = new GenericHealingPotion("Supreme Healing Potion", "10d4+20");
