...
namespace CombSimTest
{
    ...
    public class ArenaTests
    {
        ...
        public void TestNeighbours()
        {
            ...
            Assert.AreEqual(TLneighbours, new List<Location> {new Location(0,1), new Location(1,0), new Location(1,1)});
            
            var BRneighbours = a.GetNeighbours(new Location(9, 9));
            Assert.AreEqual(BRneighbours.Count, 3);
            Assert.AreEqual(BRneighbours, new List<Location> {new Location(8,8), new Location(8,9), new Location(9,8)});
